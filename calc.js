...
function showText() {
    ...
    document.getElementById("escape").innerHTML = `Estimated score gain from 2m30s escape: ${Math.round(575 * relicmult * 150 * scoremult)}`;
    document.getElementById("final").innerHTML = `Final score: ${Math.round(score * (scoremult * relicmult) + 575 * relicmult * 150 * scoremult)}`;
}
